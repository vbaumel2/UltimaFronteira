...
public class EventoClimaticoBuilder implements EventoBuilder {
    ...
    public Evento criar(String nome){
        return switch (nome){
            case "Tempestade de areia" -> new EventoClimatico("Tempestade de areia", 4, 3, 3, 3);
            case "Nevasca" -> new EventoClimatico("Tempestade de areia", 4, 4, 5, 3);
            case "Deslizamento" -> new EventoClimatico("Deslizamento", 1, 1, 1, 12);
            case "Chuva intensa" -> new EventoClimatico("Chuva intensa", 4, 4, 3, 0);
            case "Tempestade" -> new EventoClimatico("Tempestade", 3, 4, 3, 2);
            case "Armardilhas" -> new EventoClimatico("Armadilhas", 1, 1, 0 , 10);
